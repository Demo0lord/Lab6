...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.cohen_sutherland_button = tk.Button(self.algorithm_frame, text="Первый алгоритм", command=self.cohen_sutherland_algorithm)
        self.cohen_sutherland_button.pack(side=tk.TOP, fill=tk.X)

        self.midpoint_clipping_button = tk.Button(self.algorithm_frame, text="Второй алгоритм", command=self.midpoint_clipping_algorithm)
